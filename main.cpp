...
int main(int argc, char *argv[])
{
    ...
    string data_path = "/home/tan/projects/mapping/data/rgbd-frames";
    ...
    float voxel_grid_origin_z = -5.5f;
    // TSDF voxel num 10e6
    int voxel_grid_dim_x = 100;
    int voxel_grid_dim_y = 40;
    int voxel_grid_dim_z = 100;
    float voxel_size = 0.1f; // voxel resolution
    ...
    for (int frame_idx = first_frame_idx; frame_idx < first_frame_idx + (int)num_frames; frame_idx++)
    {
        ...
        cout << "Fusing: " << depth_im_file << endl;
